...
public class TimerCommand implements CommandExecutor {
    ...
    private void sendUsage(CommandSender sender) {
        sender.sendMessage(ChatColor.GRAY + "Verwendung" + ChatColor.DARK_GRAY + ": " + ChatColor.BLUE +
                "/timer resume, /timer pause, /timer time <Zeit>, /timer reset, /timer info" + ChatColor.GREEN + "\n" + "Plugin von _TheMarCraft_" + "\n" + ChatColor.GRAY + "Permission: " + ChatColor.RED + "cf.tmcz.timer");
    }
